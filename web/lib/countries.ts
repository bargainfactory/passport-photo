...
export const COUNTRIES: CountrySpec[] = [
  // Americas
  {
    ...
    region: "Americas",
    passport: { width_mm: 51, height_mm: 51, bg_color: [255, 255, 255], head_pct: [67, 67], eye_line_pct: [56, 69], crown_top_mm: 3, max_file_size_kb: 230 },
    visa:     { width_mm: 51, height_mm: 51, bg_color: [255, 255, 255], head_pct: [67, 67], eye_line_pct: [56, 69], crown_top_mm: 3, max_file_size_kb: 230 },
  ...
  // Europe
  {
    ...
    region: "Europe",
    passport: { width_mm: 35, height_mm: 45, bg_color: [255, 255, 255], head_pct: [67, 67], eye_line_pct: [56, 69], crown_top_mm: 3 },
    visa:     { width_mm: 35, height_mm: 45, bg_color: [255, 255, 255], head_pct: [67, 67], eye_line_pct: [56, 69], crown_top_mm: 3 },
    glasses: false, headgear: false,
